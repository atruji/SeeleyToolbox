...
%setenv('FSLDIR', '/usr/local/fsl'); % main FSL directory
setenv('FSLDIR', '/usr/share/fsl/5.0'); % main FSL directory
...
% This currently only works for single created files, not for multiple
% files
