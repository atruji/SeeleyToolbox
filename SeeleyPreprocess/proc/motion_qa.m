function [mean_displace,std_displace,max_displace,sum_displace,n_spikes,mean_transrms,std_transrms,max_transrms,sum_transrms,max_trans,mean_euler,std_euler,max_euler,sum_euler,max_rot]=motion_qa(motparams_file,show_plot,varargin)
% motion_qa.m
